...
class ANOVA_test():
    ...
    def ANOVA(self):
        ...
        for i in range(10):
            if(i == 0):
                dict_ = self.train_model(dict_,shuffle= True,path = self.path)
    ...
    def train_model(self,dict,path_ = None):
