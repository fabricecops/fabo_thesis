...
class OPS_LSTM(AUC):
    ...
    def _get_data_no_cma(self, dict_data):
        ...
        self.df_t_train['error_e'] = list(map(self._get_error_e, array_t))
        ...
        self.df_t_val['error_e'] = list(map(self._get_error_e, array_t))
        ...
        self.df_t_test['error_e'] = list(map(self._get_error_e, array_t))
        ...
        self.df_f_train['error_e'] = list(map(self._get_error_e, array_f))
        ...
        self.df_f_val['error_e'] = list(map(self._get_error_e, array_f))
        ...
        self.df_f_test['error_e'] = list(map(self._get_error_e, array_f))
    ...
    def _get_error_e(self, row):

        y = row[0]
        y_p = row[1]

        e_f = np.mean(np.power((y - y_p), 2), axis=(1, 2))
...
# def process_output(self, dict_data):
#     OPS_LSTM_ = OPS_LSTM(self.dict_c)
#     OPS_LSTM_.save_output_CMA(dict_data)
#     OPS_LSTM_.save_ROC_segment(dict_data, 'segmentation')
#     OPS_LSTM_.save_ROC_segment(dict_data, 'location')
#     OPS_LSTM_.plot_dist(dict_data)
#
#     if (dict_data['AUC_v'] > self.max_AUC_val):
#         self.max_AUC_val = dict_data['AUC_v']
#         self.max_AUC_tr = dict_data['AUC']
#         self.max_AUC_t = dict_data['AUC_t']
#         self.count_cma = 0
#     else:
#         self.count_cma += 1